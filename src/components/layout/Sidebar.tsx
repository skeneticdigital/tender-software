...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  ...
  const menuItems = [
    ...
    // Core ERP Modules
    { id: 'tenders', label: 'Tender Module', icon: FileText, roles: ['*'] },
    { id: 'estimates', label: 'Estimate Module', icon: Calculator, roles: ['*'] },
    { id: 'rate-analysis', label: 'Rate Calculations', icon: TrendingUp, roles: ['*'] },
    { id: 'work-orders', label: 'Work Order Module', icon: FileSpreadsheet, roles: ['*'] },
    { id: 'projects', label: 'Project Management', icon: HardHat, roles: ['*'] },
    { id: 'materials', label: 'Material Management', icon: Package, roles: ['*'] },
    { id: 'inventory', label: 'Inventory & Dispatch', icon: Warehouse, roles: ['*'] },
    { id: 'machinery', label: 'Machinery Management', icon: Truck, roles: ['*'] },
    { id: 'labour', label: 'Labour Management', icon: Users, roles: ['*'] },
