              ...
              {loading ? (
                ...
                bills.map((b) => (
                  <tr key={b.id} className="hover:bg-slate-50/80 transition-colors">
                    <td className="px-4 py-3.5 font-bold text-slate-900">{b.billNumber}</td>
                    ...
                    <td className="px-4 py-3.5 text-right font-bold text-blue-700">{formatINR(b.netPayable)}</td>

                    <td className="px-4 py-3.5 text-right font-bold text-slate-900">{formatINR(b.outstandingAmount)}</td>
                    ...
                    <td className="px-4 py-3.5 text-center">
                      <div className="flex justify-center gap-1">
                        ...
                        <button
                          onClick={() => {
                            alert(`Editing bill ${bill.billNumber}`);
                          }}
                          className="p-1.5 hover:bg-slate-200 text-slate-600 rounded-lg transition-colors"
                          title="Edit Bill"
                        >
